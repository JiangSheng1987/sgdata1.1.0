...
<div class="admin">
    ...
    <div class="panel admin-panel">
    	<div class="panel-head"><strong>教师任课情况</strong></div>
        ...
        <table class="table table-hover">
            ...
            <s:iterator value="teachingInfo" id="lss" >
            <tr>
            	<td><s:property value="#lss.teacher.teaID" /></td>
            	<td><s:property value="#lss.teacher.teaName" /></td>
            	<td><s:property value="#lss.course.courseID"/> </td>
            	<td><s:property value="#lss.course.courseName" /></td>
            	<td><s:property value="#lss.course.type" /></td>
            	<td><s:property value="#lss.course.credit" /></td>
            	<td>
            		<a class="button border-blue button-little" href='getCourseStudentsInfoAction?courseID=<s:property value='#lss.course.courseID' />'>
            		学生名单
            		</a>
            	</td>
            </tr>
