...
<div class="admin">
    ...
    <div class="panel admin-panel">
    	<div class="panel-head"><strong>教师指导比赛</strong></div>
        ...
        <table class="table table-hover">
            ...
            <s:iterator value="matchGuideInfo" id="lss" >
            <tr>
            	<td><s:property value="#lss.teacher.teaID" /></td>
            	<td><s:property value="#lss.teacher.teaName" /></td>
            	<td><s:hidden value='<s:property value="#lss.match.matchID"/>'></s:hidden></td>
            	<td><s:property value="#lss.match.matchName" /></td>
            	<td><s:property value="#lss.match.matchTime" /></td>
            	<td><s:property value="#lss.match.matchReward" /></td>
            	<td>
            		<a class="button border-blue button-little" href='getMatchStudentsInfoAction?matchID=<s:property value='#lss.match.matchID' />'>学生名单</a>
            	</td>
            </tr>
            </s:iterator>
        </table>
