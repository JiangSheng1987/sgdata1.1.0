    ...
    <div class="mainer">
        <div class="admin-navbar">
            <span class="float-right">
                ...
                <a class="button button-little bg-yellow" href="gotoLoginAction">注销登录</a>
            </span>
...
<div class="admin">
    ...
    <div class="panel admin-panel">
    	<div class="panel-head"><strong>比赛信息列表</strong></div>
        ...
        <table class="table table-hover">
        	<tr>
        		...
        		<th width="120">选择</th>
        		-->
        		<th width="120">比赛ID号</th>
        		<th width="120">比赛名称</th>
        		<th width="120">参赛时间</th>
        		<th width="120">获奖情况</th>
        		<th width="120">操作</th>
        	</tr>
        	<s:iterator value="matchesInfo" id="msif">
            <tr>
            	<!--  
            	<td><input type="checkbox" name="id" value="1" /></td>
            	-->
            	<td><s:property value="#msif.matchID"/></td>
            	<td><s:property value="#msif.matchName"/></td>
            	<td><s:property value="#msif.matchTime"/></td>
            	<td><s:property value="#msif.matchReward"/></td>
            	<td>
	            	<a class="button border-blue button-little" href='getStudentsInfoAction?matchID=<s:property value='#msif.matchID' />'>学生名单</a> 
            	</td>
            </tr>
            </s:iterator>
        </table>
        ...
        <div class="panel-foot text-center">
        	 共<s:property value="allRow"/>条记录    
          	...
          	<!-- currentPage为当前页 -->
	        <s:else>
	           <ul class="pagination"><li><a href="getAllMatchInfoAction.action?page=1">第一页</a></li></ul>
	           <ul class="pagination"><li><a href="getAllMatchInfoAction.action?page=<s:property value="%{currentPage-1}"/>">上一页</a></li></ul>
	        </s:else>
          	
          	<s:if test="%{currentPage != totalPage}">
         	 <ul class="pagination"><li><a href="getAllMatchInfoAction.action?page=<s:property value="%{currentPage+1}"/>">下一页</a></li></ul>
         	 <ul class="pagination"><li><a href="getAllMatchInfoAction.action?page=<s:property value="totalPage"/>">最后一页</a></li></ul>
            </s:if>
