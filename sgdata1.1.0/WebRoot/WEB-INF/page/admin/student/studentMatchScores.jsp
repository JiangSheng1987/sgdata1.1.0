...
<div class="admin">
    ...
    <div class="panel admin-panel">
    	<div class="panel-head"><strong>学生比赛成绩</strong></div>
    	
        <table class="table table-hover">
        	<tr>
        		<th width="120">学号</th>
        		<th width="120">姓名</th>
        		<th width="120">指导老师</th>
        		<th width="120">比赛名称</th>
        		<th width="120">比赛时间</th>
        		<th width="120">获奖情况</th>
        	</tr>
            <s:iterator value="matchScores" id="mss" >
            <tr>
            	<td><s:property value="#mss.student.stuID" /></td>
            	<td><s:property value="#mss.student.stuName" /></td>
            	<td><s:property value="#mss.teacher.teaName"/></td>
            	<td><s:property value="#mss.match.matchName" /></td>
            	<td><s:property value="#mss.match.matchTime" /></td>
            	<td><s:property value="#mss.match.matchReward" /></td>
            </tr>
            </s:iterator>
        </table>
