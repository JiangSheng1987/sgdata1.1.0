    ...
    <div class="mainer">
        <div class="admin-navbar">
            <span class="float-right">
                ...
                <a class="button button-little bg-yellow" href="admin/login.jsp">注销登录</a>
            </span>
            <ul class="nav nav-inline admin-nav">
                <li class="active"><a href="index.jsp" class="icon-home"> 开始</a>
                    <ul>
                    	...
                    	<li><a href="#">任课教师/指导教师</a></li>
                    	<li><a href="#">比赛情况</a></li>
                    </ul>
                </li>
                <li><a href="admin/systemManager.jsp" class="icon-cog"> 系统</a>
            		<ul>
            			<li><a href="#">全局设置</a></li>
        ...
        <div class="admin-bread">
            ...
            <ul class="bread">
                <li><a href="admin/index.jsp" class="icon-home"> 开始</a></li>
                <li><a href="admin/systemManager.jsp">设置</a></li>
                <li>系统设置</li>
            </ul>
        </div>
    </div>
